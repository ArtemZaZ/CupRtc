...
protocolFormatDescription = {  # описание форматов пакетов по дескриптору
    1: '=H',  # пакет данных c количеством блоков - 2 байта
    2: '=B100B',   # пакет данных с номером текста и 100 символами текста (юзайте в конце нуль-терминальную строку)
    3: '=20B',   # 20 байт speex файла
    4: '=B',    # обратная связь
}
